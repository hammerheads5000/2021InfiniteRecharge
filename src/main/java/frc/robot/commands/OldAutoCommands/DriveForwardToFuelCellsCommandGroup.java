...
public class DriveForwardToFuelCellsCommandGroup extends SequentialCommandGroup {
   ...
   */
  public DriveForwardToFuelCellsCommandGroup(AutoDriveSub drive, DrivetrainSub m_drivetrainSub) {
    // Add your commands in the super() call, e.g.
    // super(new FooCommand(), new BarCommand());
    super(
      new AutoForwardsOrBackwardsCommand(drive, m_drivetrainSub, Constants.LEFT_AUTO_FORWARDS_FUEL_CELLS_DISTANCE),
